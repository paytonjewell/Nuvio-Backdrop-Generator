        ...
        <Card onReset={onReset}>
          ...
          <Field>
            ...
            {(layout.autoStagger ?? true) ? (
              ...
              >
                Computed from card size
              </div>
            ) : (
              <RangeRow
                min={0}
                max={400}
                value={layout.stagger}
                displayValue={`${layout.stagger}px`}
          ...
          <Field>
            ...
            <RangeRow
              ...
              displayValue={`${layout.imageOpacity}%`}
          ...
          <Field>
            ...
            <RangeRow
              ...
              displayValue={`${layout.offsetX}px`}
          ...
          <Field>
            ...
            <RangeRow
              ...
              displayValue={`${layout.offsetY}px`}
