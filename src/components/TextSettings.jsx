            ...
            <div className={s.posGrid}>
              {POSITIONS.map((p) => (
                <button
                  ...
                  onClick={() =>
                    set({ preset: p.value, offsetX: 0, offsetY: 0 })
                  }
          ...
          <Field>
            ...
            {text.shadow && (
              <RangeRow
                ...
                displayValue={`${text.shadowBlur}px`}
